    ...
    S.prototype.pullData = function(e, i) {
        ...
        if (a.startTime = (new Date).getTime(), n.url) {
            ...
            t.ajax({
                ...
                headers: n.headers || {},
                success: function(t) {
                    t[r.statusName] != 200 ? (a.renderForm(), a.layMain.html('<div class="' + f + '">' + (t[r.msgName] || "返回的数据状态异常") + "</div>")) : (a.renderData(t, e, t[r.countName]), d(), n.time = (new Date).getTime() - a.startTime + " ms"),
                    i && l.close(i),
